    ...
    <form id="form1" runat="server">
        <div style="width:48%; margin-left:16%; margin-right:36%; margin-top:5%;">
			<asp:Panel runat="server" ID="pnlMain" Width="100%" Height="800px" BackColor="#EFEFEF">
				...
				<div style="margin-left:10%; margin-top:30px; margin-right:10%; margin-bottom:30px;">
					<asp:Label runat="server" ID="Label1" Font-Names="微軟正黑體" Font-Size="18" Width="30%">確認密碼</asp:Label>
					<asp:TextBox runat="server" ID="tbx3" Width="50%" Height="20px" TextMode="Password"></asp:TextBox>
				</div>
				<div style="margin-left:10%; margin-top:30px; margin-right:10%; margin-bottom:30px;">
				...
				<div style="margin-left:10%; margin-top:30px; margin-right:10%; margin-bottom:30px;">
					...
					<asp:TextBox runat="server" ID="tbx5" Width="50%" Height="20px"></asp:TextBox>
				</div>
