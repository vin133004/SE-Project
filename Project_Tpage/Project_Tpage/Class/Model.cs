...
namespace Project_Tpage.Class
{
    ...
    public abstract class SqlServ
    {
        ...
        /// <returns></returns>
        public abstract string Type(string str, bool isCH = false);
        /// <summary>
        /// 將特定型別的資料轉換為SQL字串的表示方式。
        /// </summary>
        /// <param name="gd">性別格式。</param>
        /// <returns></returns>
        public abstract string Type(Gender gd);
        /// <summary>
        /// 將特定型別的資料轉換為SQL字串的表示方式。
        /// </summary>
        /// <param name="upr">使用者隱私格式。</param>
        /// <returns></returns>
        public abstract string Type(UserPrivacy upr);
        /// <summary>
        /// 將特定型別的資料轉換為SQL字串的表示方式。
        /// </summary>
        /// <param name="nt">整數格式。</param>
        /// <returns></returns>
        public abstract string Type(int nt);
        /// <summary>
        /// 將特定型別的資料轉換為SQL字串的表示方式。
        /// </summary>
        /// <param name="img">圖片格式。</param>
        /// <returns></returns>
        public abstract string Type(Image img);
        /// <summary>
        /// 將特定型別的資料轉換為SQL字串的表示方式。
        /// </summary>
        ...
        /// <param name="isCH">是否含中文字元。</param>
        /// <returns></returns>
        public abstract string Type(List<string> ls, bool isCH = false);
        /// <summary>
        /// 將特定型別的資料轉換為SQL字串的表示方式。
        /// </summary>
        /// <param name="dt">日期格式。</param>
        /// <param name="onlyDate">是否只儲存日期資訊。</param>
        /// <returns></returns>
        public abstract string Type(DateTime dt, bool onlyDate = false);
        /// <summary>
        /// 將User的帳號與帳號識別碼進行轉換。
        /// </summary>
        ...
        /// <returns></returns>
        public abstract string UserID_UIDconvert(string ipt, bool foword = true);
        ...
        public object AnlType<T>(object obj)
        {
            ...
            {
                if (obj is DBNull || obj == null || (((byte[])obj).Length == 1 && ((byte[])obj)[0] == 0)) return null;
    ...
    /*
    public class SqlServ_H2 : SqlServ
    {
...
*/
    ...
    public class SqlServ_MSSql : SqlServ
    {
        ...
        /// <param name="isCH">是否含中文字元。</param>
        /// <returns></returns>
        public override string Type(string str, bool isCH = false)
        {
        ...
        /// <param name="gd">性別格式。</param>
        /// <returns></returns>
        public override string Type(Gender gd)
        {
            return "" + ((byte)gd);
        }
        /// <summary>
        ...
        /// <param name="upr">使用者隱私格式。</param>
        /// <returns></returns>
        public override string Type(UserPrivacy upr)
        {
            return "" + ((byte)upr);
        }
        /// <summary>
        ...
        /// <returns></returns>
        public override string Type(int p_int)
        {
            return "" + p_int;
        }
        /// <summary>
        ...
        /// <param name="img">圖片格式。</param>
        /// <returns></returns>
        public override string Type(Image img)
        {
        ...
        /// <param name="isCH">是否含中文字元。</param>
        /// <returns></returns>
        public override string Type(List<string> ls, bool isCH = false)
        {
        ...
        /// <param name="dt">日期格式。</param>
        /// <returns></returns>
        public override string Type(DateTime dt, bool onlyDate = false)
        {
            if (onlyDate)
        ...
        /// <param name="foword">將帳號轉換為識別碼(true)或是將識別碼轉換為帳號(false)。</param>
        /// <returns></returns>
        public override string UserID_UIDconvert(string ipt, bool foword = true)
        {
        ...
        public override object Get<T>(string Iden)
        {
            if (typeof(T).Equals(typeof(User)))
            {
                ...
                if (dt.Rows.Count <= 0)
                {
                    throw new Exception("無此帳號。UID = " + Iden);
                }
                else
                {
            ...
            else if (typeof(T).Equals(typeof(Article)))
            {
                ...
                if (dt.Rows.Count == 0)
                    throw new Model.ModelException("無此文章。AID = " + Iden);
                else
            ...
            else if (typeof(T).Equals(typeof(AMessage)))
            {
                ...
                if (dt.Rows.Count == 0)
                    throw new Model.ModelException("無此留言。MID = " + Iden);
                else
            ...
            else if (typeof(T).Equals(typeof(ClassGroup)))
            {
                ...
                if (dt.Rows.Count == 0)
                    throw new Exception("無此班級。GID : " + Iden);
                else
            ...
            else if (typeof(T).Equals(typeof(FamilyGroup)))
            {
                ...
                if (dt.Rows.Count == 0)
                    throw new Exception("無此家族。GID : " + Iden);
                else
    ...
    public abstract class SQLS
    {
        ...
        {
            if (p_str == null || p_str == string.Empty)
                return "''";
            else if (isCH)
                return "N'" + p_str + "'";
            else
        ...
        {
            if (p_img == null) return "0x00";
            
            return string.Format("CAST({0} AS IMAGE)",
                "0x" + string.Concat(((byte[])new ImageConverter().ConvertTo(p_img, typeof(byte[]))).Select
                (x => Convert.ToString(x, 16).PadLeft(2, '0'))));
        }
        /// <summary>
        /// 將特定型別的資料轉換為SQL字串的表示方式。
        ...
        {
            if (p_ls == null || p_ls.Count <= 0) return "''";
        ...
        {
            if (onlyDate)
                return string.Format("'{0}'", p_dt.ToString("yyyy-MM-dd 00:00:00"));
            else
                return string.Format("'{0}'", p_dt.ToString("yyyy-MM-dd HH:mm:ss"));
        }
        ...
        /// <param name="obj">從資料庫讀取的資料。</param>
        /// <returns></returns>
        public static object AnlType<T>(object obj)
        {
            if (typeof(T).Equals(typeof(DateTime)))
            {
                if (obj is DBNull || obj == null || (string)obj == "") return DateTime.MinValue;
            ...
            {
                if (obj is DBNull || obj == null || ((byte[])obj).ToList().Equals(new List<byte>() { 0 })) return null;
